...
export default function Breeds() {
    return (
        <>
            <div style={{paddingTop:'20px',paddingBottom:'0px'}} className="lg:max-w-[1600px] lg:py-20 lg:px-16 mx-auto text-center space-x-20">
                <div className="mb-16">
                ...
                <div style={{width:'85%'}} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <button style={{background:'black',paddingTop:'15px',paddingBottom:'15px',paddingLeft:'36px',paddingRight:'31px'}}
