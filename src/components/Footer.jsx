...
const phone_number = "+91-8838822782";
export default function Footer() {
    let date = new Date();
    let year = date.getFullYear();
    return (
        <>
            <footer style={{backgroundColor:'white'}} className="lg:max-w-[1600px] lg:py-20 lg:px-16 flex flex-col dark-blue-background text-white mx-auto">
                {/* upper footer */}
                <div className="flex flex-row flex-wrap justify-between align-middle">
                    ...
                    <div className="flex flex-col flex-wrap w-1/2 text-justify space-y-10">
                        <div className="flex flex-row justify-between align-middle space-x-10">
                            <h2 className="font-bold text-xl w-4/5 text-center"><h1 style={{color:'white',paddingRight:'120px',fontSize:'30px',fontWeight:'bold'}}>Petnic</h1> </h2>
                            <p className="text-lg">
                                &quot;Petnic is a new digital platform with real people behind the scenes. Our platform connects potential adopters with people who need to rehome their pets.&quot;
                            </p>
                        </div>
                        ...
                        <div>
                            ...
                            <p className="font-bold text-xl">Coimbatore-SKCET</p>
                        </div>
                ...
                <div className="flex flex-row justify-between">
                    <p className="text-lg font-medium">Copyright © {year} Petnic | All Rights Reserved</p>
